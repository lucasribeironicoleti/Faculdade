...
import br.com.projetoproduto.dao.TipoCarroDAOImpl;
 ...
 * @author Human
 */
@WebServlet(name = "CarregarTipoCarro", urlPatterns = {"/CarregarTipoCarro"})
public class CarregarTipoCarro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GenericDAO dao = new TipoCarroDAOImpl();
            System.out.println("Passei1");
            request.setAttribute("tipocarro", dao.listar());
